...
#define gp2x_screen16	((unsigned short *)screenBuffer)

#ifdef __cplusplus
extern "C" {
#endif

extern unsigned char screenBuffer[1024*1024*2];
...
extern void gp2x_change_res(int w, int h, int bpp);
extern void gp2x_video_RGB_clearscreen16(void);
extern unsigned long timeGetTime();
extern unsigned int emu_screen_w;
extern unsigned int emu_screen_h;
extern unsigned int emu_screen_bpp;
extern unsigned int emu_screen_pitch;
...
#define gp2x_video_flip() flip_screen()
